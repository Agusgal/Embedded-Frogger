...
${OBJECTDIR}/Audio.o: Audio.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Audio.o Audio.c

${OBJECTDIR}/Check_Frog.o: Check_Frog.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Check_Frog.o Check_Frog.c

.NO_PARALLEL:${OBJECTDIR}/Draw\ Vehicules.o
${OBJECTDIR}/Draw\ Vehicules.o: Draw\ Vehicules.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Draw\ Vehicules.o Draw\ Vehicules.c

${OBJECTDIR}/Draw_Frog.o: Draw_Frog.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Draw_Frog.o Draw_Frog.c

.NO_PARALLEL:${OBJECTDIR}/Game\ Threads.o
${OBJECTDIR}/Game\ Threads.o: Game\ Threads.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game\ Threads.o Game\ Threads.c

.NO_PARALLEL:${OBJECTDIR}/Scoring\ System.o
${OBJECTDIR}/Scoring\ System.o: Scoring\ System.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scoring\ System.o Scoring\ System.c

${OBJECTDIR}/Screens.o: Screens.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Screens.o Screens.c

${OBJECTDIR}/gameboard.o: gameboard.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gameboard.o gameboard.c

${OBJECTDIR}/main_frogger.o: main_frogger.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_frogger.o main_frogger.c
